...
YAML type: `end` | Fixed ID: `"900001"`

```yaml
    - id: "900001"
      type: end
      title: 结束
      icon: https://lf3-static.bytednsdoc.com/obj/eden-cn/.../icon-End-v2.jpg
        ...
        node_inputs:
            - name: output
              input:
                value:
                    path: output
                    ref_node: "<upstream_node_id>"
        terminatePlan: returnVariables  # or useAnswerContent
```
